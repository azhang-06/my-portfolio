...
export const SunSketcher: SunSketcherProject = {
    ...
    description: "An app that helps scientists collect a comprehensive database of images from citizens.",
    mainImage: "/projectImages/SunSketcher/ProjectCover.png",
    projectSub: {
        overview: {
            discover: "Research on users in the next total solar eclipse path: Greenland, Iceland, and Spain.",
            ideaPrototype: "Based on user research, creating the next iteration of the app in Figma.",
            evaluate: "Create UX testing materials (consent form, script, and other instruments), recruit participants, and lead testing!",
