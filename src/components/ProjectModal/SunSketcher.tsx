...
import Section1 from "../ProjectSections/SunSketcher/Section1"
import Section2 from "../ProjectSections/SunSketcher/Section2"
import Section3 from "../ProjectSections/SunSketcher/Section3"
import Section4 from "../ProjectSections/SunSketcher/Section4"
import Section5 from "../ProjectSections/SunSketcher/Section5"
import Section6 from "../ProjectSections/SunSketcher/Section6"
import Section7 from "../ProjectSections/SunSketcher/Section7"
import Image from "next/image"

const SunSketcherModal = ({ project, setModal }: { project: SunSketcherProject, setModal: React.Dispatch<React.SetStateAction<SunSketcherProject | undefined>> }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg py-12 px-10 lg:px-20 max-w-7xl w-11/12 relative z-10 max-h-10/12 overflow-y-auto">
        ...
        <hr className="my-5" />
        <Section7 project={project.projectSub} />
      </div>
...
export default SunSketcherModal